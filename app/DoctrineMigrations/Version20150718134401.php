...
class Version20150718134401 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, complaint_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, user_id INT NOT NULL, report VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_C42F7784EDAE188E (complaint_id), INDEX IDX_C42F7784F8697D13 (comment_id), INDEX IDX_C42F7784A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
